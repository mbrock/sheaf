  ...
  test "renders quick chat messages and research notes in session groups" do
    ...
    graph =
      RDF.Graph.new([
        ...
        {research_user, AS.content(),
         RDF.literal("Map the strongest evidence.")},
        {research_user, AS.published(),
         RDF.literal(~U[2026-04-26 13:13:00Z])},
        ...
        {note, AS.content(),
         RDF.literal("Strongest evidence sits in #ABC123.")},
